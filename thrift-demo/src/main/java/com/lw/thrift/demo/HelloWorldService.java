...
public class HelloWorldService {
	...
	public interface Iface {
		...
		public java.lang.String sayHello(com.lw.thrift.demo.User user) throws org.apache.thrift.TException;

	}

	public interface AsyncIface {

		public void sayHello(com.lw.thrift.demo.User user,
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public void send_sayHello(com.lw.thrift.demo.User user) throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
			private com.lw.thrift.demo.User user;

			public sayHello_call(com.lw.thrift.demo.User user,
					org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler,
	...
	public static class sayHello_args implements org.apache.thrift.TBase<sayHello_args, sayHello_args._Fields>,
		...
		public com.lw.thrift.demo.User user; // required
		...
		public sayHello_args(com.lw.thrift.demo.User user) {
			this();
			this.user = user;
		}
		...
		public sayHello_args(sayHello_args other) {
			if (other.isSetUser()) {
				this.user = new com.lw.thrift.demo.User(other.user);
			}
		}
		...
		public com.lw.thrift.demo.User getUser() {
			return this.user;
		}

		public sayHello_args setUser(com.lw.thrift.demo.User user) {
			this.user = user;
			return this;
		}
		...
		public void setFieldValue(_Fields field, java.lang.Object value) {
			...
			case USER:
				if (value == null) {
					...
					setUser((com.lw.thrift.demo.User) value);
				}
				break;
				...
				while (true) {
					...
					case 1: // USER
						if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
							struct.user = new com.lw.thrift.demo.User();
